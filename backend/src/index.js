...
const studentFeeProfilesRoutes = require('./routes/studentFeeProfiles.routes');
...
const principalPortalRoutes = require('./routes/principalPortal.routes');
...
app.use('/api/student-fee-profiles', studentFeeProfilesRoutes);
...
app.use('/api/principal-portal', principalPortalRoutes);
